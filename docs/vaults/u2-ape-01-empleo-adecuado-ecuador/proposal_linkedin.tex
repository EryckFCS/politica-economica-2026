...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\sffamily\small\color{secondary}INVESTIGACIÓN ACADÉMICA}
\fancyhead[R]{\sffamily\small\color{secondary}ANÁLISIS ECONÓMICO}
\fancyfoot[L]{\sffamily\small\color{gray}Erick Condoy Seraquive}
