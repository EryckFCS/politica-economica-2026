# Roadmap - Política Económica 2026
...
1. Mantener la documentación viva en `docs/` antes de agregar nuevos artefactos.
2. Consolidar la bibliografía local y el reindexado del cerebro central sin duplicar material.
3. Expandir la cobertura de pruebas si aparecen nuevas rutas públicas o helpers reutilizables.
4. Agregar nuevas unidades académicas solo si existen entregables concretos para cada una.
